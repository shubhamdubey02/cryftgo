...
type txSigner struct {
	cryftKC keychain.Keychain
	ethKC   EthKeychain
	backend SignerBackend
}

func NewSigner(cryftKC keychain.Keychain, ethKC EthKeychain, backend SignerBackend) Signer {
	return &txSigner{
		cryftKC: cryftKC,
		ethKC:   ethKC,
		backend: backend,
...
func (s *txSigner) getImportSigners(ctx stdcontext.Context, sourceChainID ids.ID, ins []*cryft.TransferableInput) ([][]keychain.Signer, error) {
