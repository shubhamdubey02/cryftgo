...
func (b *builder) NewBaseTx(
	...
	cryft.SortTransferableOutputs(outputs, Parser.Codec()) // sort the outputs
...
func (b *builder) NewCreateAssetTx(
	...
	toBurn := map[ids.ID]uint64{
		b.context.CRYFTAssetID: b.context.CreateAssetTxFee,
	}
	ops := common.NewOptions(options)
...
func (b *builder) NewImportTx(
	...
	cryft.SortTransferableOutputs(outputs, Parser.Codec())
	tx := &txs.ImportTx{
		BaseTx: txs.BaseTx{BaseTx: cryft.BaseTx{
			NetworkID:    b.context.NetworkID,
			BlockchainID: b.context.BlockchainID,
