...
var (
	...
	testContext = &builder.Context{
		...
		CreateAssetTxFee: 99 * units.MilliCryft,
	}
)
...
func makeTestUTXOs(utxosKey *secp256k1.PrivateKey) []*cryft.UTXO {
	...
	return []*cryft.UTXO{ // currently, the wallet scans UTXOs in the order provided here
		...
		},
		{
			...
			Asset: cryft.Asset{ID: nftAssetID},
		...
		},
		{
			...
			Asset: cryft.Asset{ID: propertyAssetID},
