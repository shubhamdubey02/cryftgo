...
//
//	mockgen -package=scheduler -destination=vms/proposervm/scheduler/mock_scheduler.go github.com/shubhamdubey02/cryftgoftgo/vms/proposervm/scheduler Scheduler
//
