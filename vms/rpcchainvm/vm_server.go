...
import (
	...
	"github.com/shubhamdubey02/cryftgo/vms/platformvm/warp/gwarp"
	"github.com/shubhamdubey02/cryftgo/vms/rpcchainvm/ghttp"
	"github.com/shubhamdubey02/cryftgo/vms/rpcchainvm/grpcutils"
	"github.com/shubhamdubey02/cryftgo/vms/rpcchainvm/messenger"
	...
	validatorstatepb "github.com/shubhamdubey02/cryftgo/proto/pb/validatorstate"
	vmpb "github.com/shubhamdubey02/cryftgo/proto/pb/vm"
	warppb "github.com/shubhamdubey02/cryftgo/proto/pb/warp"
)
...
func (vm *VMServer) Initialize(ctx context.Context, req *vmpb.InitializeRequest) (*vmpb.InitializeResponse, error) {
	...
	cryftAssetID, err := ids.ToID(req.CryftAssetId)
	if err != nil {
		return nil, err
	}
