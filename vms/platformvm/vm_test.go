...
import (
	...
	"github.com/shubhamdubey02/cryftgoftgo/snow/engine/snowman/bootstrap"
	...
	"github.com/shubhamdubey02/cryftgoftgo/snow/networking/sender"
	...
	smcon "github.com/shubhamdubey02/cryftgoftgo/snow/consensus/snowman"
	smeng "github.com/shubhamdubey02/cryftgoftgo/snow/engine/snowman"
	snowgetter "github.com/shubhamdubey02/cryftgoftgo/snow/engine/snowman/getter"
	timetracker "github.com/shubhamdubey02/cryftgoftgo/snow/networking/tracker"
	blockbuilder "github.com/shubhamdubey02/cryftgoftgo/vms/platformvm/block/builder"
	blockexecutor "github.com/shubhamdubey02/cryftgoftgo/vms/platformvm/block/executor"
	txexecutor "github.com/shubhamdubey02/cryftgoftgo/vms/platformvm/txs/executor"
	walletbuilder "github.com/shubhamdubey02/cryftgoftgo/wallet/chain/p/builder"
...
var (
	...
	// each key controls an address that has [defaultBalance] CRYFT at genesis
	keys = secp256k1.TestKeys()

	// Node IDs of genesis validators. Initialized in init function
	genesisNodeIDs           []ids.NodeID
	defaultMinDelegatorStake = 1 * units.MilliCryft
...
func defaultGenesis(t *testing.T, cryftAssetID ids.ID) (*api.BuildGenesisArgs, []byte) {
...
func defaultVM(t *testing.T, f fork) (*VM, *txstest.Builder, database.Database, *mutableSharedMemory) {
	...
	_, genesisBytes := defaultGenesis(t, ctx.CRYFTAssetID)
...
func TestGenesis(t *testing.T) {
	...
	genesisState, _ := defaultGenesis(t, vm.ctx.CRYFTAssetID)
	...
	for _, utxo := range genesisState.UTXOs {
		...
		addrs := set.Of(addr)
		utxos, err := cryft.GetAllUTXOs(vm.state, addrs)
		require.NoError(err)
		require.Len(utxos, 1)
...
func TestRestartFullyAccepted(t *testing.T) {
	...
	_, genesisBytes := defaultGenesis(t, firstCtx.CRYFTAssetID)
	...
	tx := &txs.Tx{Unsigned: &txs.ImportTx{
		...
		ImportedInputs: []*cryft.TransferableInput{{
			...
			Asset: cryft.Asset{ID: firstVM.ctx.CRYFTAssetID},
			In: &secp256k1fx.TransferInput{
				Amt: 50000,
			},
		}},
...
func TestTransferSubnetOwnershipTx(t *testing.T) {
	...
	ctx, err := walletbuilder.NewSnowContext(vm.ctx.NetworkID, vm.ctx.CRYFTAssetID)
	require.NoError(err)
