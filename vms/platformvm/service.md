...
curl -X POST --data '{
    ...
    "params" :{
        "username" :"myUsername",
        "password": "myPassword",
        "address": "P-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5"
    }
...
Get the balance of CRYFT controlled by a given address.
            ...
            "exportedOutputs": [
              {
                ...
                "output": {
                  "addresses": [
                    "P-cryft1jkjyvlwclyu42n4yuegpczpfgwrf8r9lyj0d3c"
                  ],
                  "amount": 13838124063,
                  "locktime": 0,
                  "threshold": 1
...
The response in this example indicates that CRYFT’s supply is at most 365.865 million.
...
- `validators`:
  ...
  - `delegators` is the list of delegators to this validator.
    ...
    - `stakeAmount` is the amount of nCRYFT this delegator staked.
    ...
    "validators": [
      {
        ...
        "validationRewardOwner": {
          "locktime": "0",
          "threshold": "1",
          "addresses": ["P-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5"]
        },
        "delegationRewardOwner": {
          "locktime": "0",
          "threshold": "1",
...
Returns the maximum amount of nCRYFT staking to the named node during a particular time period.
...
Get the amount of nCRYFT staked by a set of addresses. The amount returned does not include staking
rewards.
...
curl -X POST --data '{
    ...
    "params": {
        "addresses": [
            "P-cryft1pmgmagjcljjzuz2ve339dx82khm7q8getlegte"
          ],
        "validatorsOnly": true
    },
    "id": 1
  ...
  "result": {
    "tx": {
      "unsignedTx": {
        ...
        "stake": [
          {
            ...
            "fxID": "spdxUxVJQbX85MGxMHbKw1sHxMnSqJ3QBzDyDYEP3h6TLuxqQ",
            "output": {
              "addresses": ["P-cryft1tnuesf6cqwnjw7fxjyk7lhch0vhf0v95wj5jvy"],
              "amount": 48944170378,
              "locktime": 0,
              "threshold": 1
            }
        ...
        "rewardsOwner": {
          "addresses": ["P-cryft19zfygxaf59stehzedhxjesads0p5jdvfeedal0"],
          "locktime": 0,
          "threshold": 1
        }
      },
...
`P-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5` and `P-cryft1d09qn852zcy03sfc9hay2llmn9hsgnw4tp3dv6`.
...
curl -X POST --data '{
    ...
    "params" :{
        "addresses":["P-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5", "P-cryft1d09qn852zcy03sfc9hay2llmn9hsgnw4tp3dv6"],
        "limit":5,
        "encoding": "hex"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/P
