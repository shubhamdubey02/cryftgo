...
func TestTxFees(t *testing.T) {
	feeTestsDefaultCfg := StaticConfig{
		TxFee:                         1 * units.Cryft,
		CreateAssetTxFee:              2 * units.Cryft,
		CreateSubnetTxFee:             3 * units.Cryft,
		TransformSubnetTxFee:          4 * units.Cryft,
		CreateBlockchainTxFee:         5 * units.Cryft,
		AddPrimaryNetworkValidatorFee: 6 * units.Cryft,
		AddPrimaryNetworkDelegatorFee: 7 * units.Cryft,
		AddSubnetValidatorFee:         8 * units.Cryft,
