...
//
//	mockgen -package=mempool -destination=vms/platformvm/txs/mempool/mock_mempool.go github.com/shubhamdubey02/cryftgoftgo/vms/platformvm/txs/mempool Mempool
//
