...
func verifyAddValidatorTx(
	...
	if err := cryft.VerifyMemoFieldLength(tx.Memo, false /*=isDurangoActive*/); err != nil {
		return nil, err
	}
	...
	outs := make([]*cryft.TransferableOutput, len(tx.Outs)+len(tx.StakeOuts))
	copy(outs, tx.Outs)
