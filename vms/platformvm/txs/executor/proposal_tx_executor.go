...
func (e *ProposalTxExecutor) AddValidatorTx(tx *txs.AddValidatorTx) error {
	...
	// Consume the UTXOs
	cryft.Consume(e.OnCommitState, tx.Ins)
	// Produce the UTXOs
	cryft.Produce(e.OnCommitState, txID, tx.Outs)
	...
	// Consume the UTXOs
	cryft.Consume(e.OnAbortState, tx.Ins)
	// Produce the UTXOs
	cryft.Produce(e.OnAbortState, txID, onAbortOuts)
	return nil
}
...
func (e *ProposalTxExecutor) AddSubnetValidatorTx(tx *txs.AddSubnetValidatorTx) error {
	...
	cryft.Consume(e.OnAbortState, tx.Ins)
	// Produce the UTXOs
	cryft.Produce(e.OnAbortState, txID, tx.Outs)
	return nil
}
