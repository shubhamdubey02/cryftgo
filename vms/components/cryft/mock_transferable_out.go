...
//
//	mockgen -package=cryft -destination=vms/components/cryft/mock_transferable_out.go github.com/shubhamdubey02/cryftgo/vms/components/cryft TransferableOut
//
