            ...
            "asset1": {
                ...
                "initialState": {
                    "fixedCap" : [
                        {
                            "amount":100000,
                            "address": "cryft13ery2kvdrkd2nkquvs892gl8hg7mq4a6ufnrn6"
                        },
                        {
                            "amount":100000,
                            "address": "cryft1rvks3vpe4cm9yc0rrk8d5855nd6yxxutfc2h2r"
                        },
                        {
                            "amount":50000,
                            "address": "cryft1ntj922dj4crc4pre4e0xt3dyj0t5rsw9uw0tus"
                        },
                        {
                            "amount":50000,
                            "address": "cryft1yk0xzmqyyaxn26sqceuky2tc2fh2q327vcwvda"
                        }
                    ]
                }
            },
            "asset2": {
                ...
                "initialState": {
                    "variableCap" : [
                        {
                            "minters": [
                                "cryft1kcfg6avc94ct3qh2mtdg47thsk8nrflnrgwjqr",
                                "cryft14e2s22wxvf3c7309txxpqs0qe9tjwwtk0dme8e"
                            ],
                            "threshold":1
                        },
                        {
                            "minters": [
                                "cryft1y8pveyn82gjyqr7kqzp72pqym6xlch9gt5grck",
                                "cryft1c5cmm0gem70rd8dcnpel63apzfnfxye9kd4wwe",
                                "cryft12euam2lwtwa8apvfdl700ckhg86euag2hlhmyw"
                            ],
                            "threshold":2
                        }
                    ]
...
- `assetID` is the asset id of the asset which is sent. Use `CRYFT` for CRYFT exports.
- `from` are the addresses that you want to use for this operation. If omitted, uses any of your
  addresses as needed.
- `changeAddr` is the address any change will be sent to. If omitted, change is sent to one of the
  addresses controlled by the user.
...
curl -X POST --data '{
    ...
    "method" :"avm.export",
    "params" :{
        "to":"C-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5",
        "amount": 10,
        "assetID": "CRYFT",
        "from":["X-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5"],
        "changeAddr":"X-cryft1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8",
...
The AssetID for CRYFT differs depending on the network you are on.
...
- `assetID`: The ID of the asset being transferred. (The Mainnet Cryft ID is
...
- `to` is the address the CRYFT is sent to. This must be the same as the `to` argument in the
  corresponding call to the P-Chain’s `exportCRYFT` or C-Chain's `export`.
- `sourceChain` is the ID or alias of the chain the CRYFT is being imported from. To import funds
...
- Sends `amount` units of asset with ID `assetID` to address `to`. `amount` is denominated in the
  smallest increment of the asset. For CRYFT this is 1 nCRYFT (one billionth of 1 CRYFT.)
...
func main() {
    ...
    addresses = append(addresses, " X-mustang....")
...
| **AddAddresses** | add an address to the set    | `{"addAddresses":{"addresses":\["X-mustang..."\]}}`               | addresses - list of addresses to match                                                                                                 |
