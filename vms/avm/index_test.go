...
func TestIndexTransaction_Ordered(t *testing.T) {
	...
	txAssetID := cryft.Asset{ID: env.genesisTx.ID()}
...
func buildUTXO(utxoID cryft.UTXOID, txAssetID cryft.Asset, addr ids.ShortID) *cryft.UTXO {
	return &cryft.UTXO{
		UTXOID: utxoID,
		Asset:  txAssetID,
...
func buildTX(chainID ids.ID, utxoID cryft.UTXOID, txAssetID cryft.Asset, address ...ids.ShortID) *txs.Tx {
