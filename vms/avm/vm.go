...
import (
	...
	"github.com/shubhamdubey02/cryftgo/vms/avm/utxo"
	...
	"github.com/shubhamdubey02/cryftgo/vms/txs/mempool"

	blockbuilder "github.com/shubhamdubey02/cryftgo/vms/avm/block/builder"
	blockexecutor "github.com/shubhamdubey02/cryftgo/vms/avm/block/executor"
	extensions "github.com/shubhamdubey02/cryftgo/vms/avm/fxs"
	txexecutor "github.com/shubhamdubey02/cryftgo/vms/avm/txs/executor"
	xmempool "github.com/shubhamdubey02/cryftgo/vms/avm/txs/mempool"
)
...
func (vm *VM) Initialize(
	...
	vm.AddressManager = cryft.NewAddressManager(ctx)
...
func (vm *VM) initGenesis(genesisBytes []byte) error {
	...
	// secure this by defaulting to cryftAsset
	vm.feeAssetID = vm.ctx.CRYFTAssetID
...
func (vm *VM) LoadUser(
	...
	*secp256k1fx.Keychain,
	...
	utxos, err := cryft.GetAllUTXOs(vm.state, kc.Addresses())
	if err != nil {
...
func (vm *VM) selectChangeAddr(defaultAddr ids.ShortID, changeAddr string) (ids.ShortID, error) {
	...
	addr, err := cryft.ParseServiceAddress(vm, changeAddr)
	if err != nil {
...
func (vm *VM) onAccept(tx *txs.Tx) error {
	...
	inputUTXOs := make([]*cryft.UTXO, 0, len(inputUTXOIDs))
