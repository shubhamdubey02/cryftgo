...
indexer node located at [https://indexer-demo.cryft.network](https://indexer-demo.cryft.network). This
...
```sh
curl --location --request POST 'https://indexer-demo.cryft.network/ext/index/X/tx' \
--header 'Content-Type: application/json' \
--data-raw '{
   "jsonrpc": "2.0",
   "method": "index.getContainerByIndex",
...
}' -H 'content-type:application/json;' https://api.cryft.network/ext/bc/X
```
