...
//
//	mockgen -package=tracker -destination=snow/networking/tracker/mock_resource_tracker.go github.com/shubhamdubey02/cryftgo/snow/networking/tracker Tracker
//
