...
//
//	mockgen -package=tracker -destination=snow/networking/tracker/mock_resource_tracker.go github.com/shubhamdubey02/cryftgoftgo/snow/networking/tracker Tracker
//
