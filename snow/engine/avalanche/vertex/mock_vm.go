...
//
//	mockgen -package=vertex -destination=snow/engine/avalanche/vertex/mock_vm.go github.com/shubhamdubey02/cryftgo/snow/engine/avalanche/vertex LinearizableVM
//
