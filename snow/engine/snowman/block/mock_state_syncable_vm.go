...
//
//	mockgen -package=block -destination=snow/engine/snowman/block/mock_state_syncable_vm.go github.com/shubhamdubey02/cryftgoftgo/snow/engine/snowman/block StateSyncableVM
//
