...
//
//	mockgen -package=block -destination=snow/engine/snowman/block/mock_with_verify_context.go github.com/shubhamdubey02/cryftgoftgo/snow/engine/snowman/block WithVerifyContext
//
