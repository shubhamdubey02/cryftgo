...
# DOCKER_IMAGE=cryftplatform/cryftgo ./scripts/build_image.sh      # Build and push multi-arch image to docker hub
...
# The published name should be 'cryftplatform/cryftgo', but to avoid unintentional
