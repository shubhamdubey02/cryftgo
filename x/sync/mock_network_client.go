...
// Source: github.com/shubhamdubey02/cryftgo/x/sync (interfaces: NetworkClient)
//
// Generated by this command:
//
//	mockgen -package=sync -destination=x/sync/mock_network_client.go github.com/shubhamdubey02/cryftgoftgo/x/sync NetworkClient
//
