...
var _ = e2e.DescribePChain("[Permissionless Subnets]", func() {
	...
	ginkgo.It("subnets operations",
		func() {
			...
			ginkgo.By(fmt.Sprintf("Send 100 MegaCryft of asset %s to the P-chain", subnetAssetID), func() {
			...
			ginkgo.By(fmt.Sprintf("Import the 100 MegaCryft of asset %s from the X-chain into the P-chain", subnetAssetID), func() {
