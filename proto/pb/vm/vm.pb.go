...
type InitializeRequest struct {
	...
	CryftAssetId  []byte `protobuf:"bytes,8,opt,name=cryft_asset_id,json=cryftAssetId,proto3" json:"cryft_asset_id,omitempty"`
...
func (x *InitializeRequest) GetCryftAssetId() []byte {
	if x != nil {
		return x.CryftAssetId
	}
	return nil
}
